...
| **2023** | *Squeezed knots and slice torus invariants* ([slides]({{ site.baseurl }}/files/slides/oralExam.pdf)) | Candidacy Oral Exam      
| 	| *Slice torus invariants and genus minimizing cobordisms* ([slides]({{ site.baseurl }}/files/slides/slideTorus.pdf)) | Harvard, GSTGC 2023
...
| **2020**	| *Topological quantum field theory and the Jones polynomial* | Brandeis GSS 
